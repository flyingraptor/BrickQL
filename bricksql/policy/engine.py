...
* **Parameter-bound columns** – columns designated by :class:`TablePolicy` must
  ...
  raise :class:`~bricksql.errors.MissingParamError`.
...
:class:`TablePolicy`.  The :class:`~bricksql.schema.snapshot.SchemaSnapshot`
...
from bricksql.schema.expressions import OPERAND_KEYS
from bricksql.schema.query_plan import LimitClause, QueryPlan
...
class PolicyConfig:
    ...
    Attributes:
        ...
        inject_missing_params: If ``True``, automatically inject param-bound
            ...
            :class:`~bricksql.errors.MissingParamError` instead.
